...
public final class updateresult_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    UserDataBeans sudb = new UserDataBeans();
    
        
    
    //検索語句データをもつUserDataBeans
    if(request.getAttribute("search") != null){
        sudb = (UserDataBeans)request.getAttribute("search");
    }
      ...
      out.write("    <body>\n");
      out.write("        ");
if(jh.chkinput(udb.chkproperties()) == ""){
      out.write("\n");
      ...
      out.write("\n");
      out.write("        ");
      out.print(jh.chkinput(udb.chkproperties()));
      out.write("\n");
      out.write("        <a href=\"javascript:history.go(-1)\">戻る</a>\n");
      out.write("        ");
}
      out.write("\n");
      out.write("    ");
      out.print(jh.searchresult(sudb.getName(),sudb.getYear(),sudb.getType()));
      out.write("\n");
      out.write("    ");
      out.print(jh.home());
      out.write("\n");
