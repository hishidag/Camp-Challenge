...
public final class update_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if(hs.getAttribute("resultData") != null){
 ...
 for(int i=1950; i<=2010; i++){ 
      ...
      out.write('"');
      out.write(' ');
if( i == jh.getYear(udd.getBirthday())){
 ...
 for(int i = 1; i<=12; i++){ 
      ...
      out.write('"');
      out.write(' ');
if( i == jh.getMonth(udd.getBirthday())){
      out.write("selected=\"selected\"");
}
      out.write('>');
      out.print(i);
 ...
 for(int i = 1; i<=31; i++){ 
      ...
      out.print(i);
      out.write('"');
if( i == jh.getDay(udd.getBirthday())){
      out.write("selected=\"selected\"");
}
      out.write('>');
      out.print(i);
...
if(i == udd.getType()){
      ...
      out.write("        <input type=\"hidden\" name=\"uac\" value=\"");
      out.print(hs.getAttribute("uac"));
      out.write("\">\n");
      out.write("        <input type=\"submit\" name=\"btnSubmit\" value=\"確認画面へ\">\n");
      out.write("    </form>\n");
      out.write("        <br>\n");
      out.write("        <!--詳細画面の更新の必要はないのでブラウザバックする-->\n");
      out.write("        <a href=\"javascript:history.go(-1)\">詳細画面へ戻る</a>\n");
      out.write("    </body>\n");
      out.write("    ");
      out.print(jh.home());
      out.write("\n");
