...
public class DeleteResult extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{            
            ...
            String accesschk = request.getParameter("dac");
            //アクセスチェック
            if(accesschk == null || (Integer)hs.getAttribute("dac") != Integer.parseInt(accesschk)){ 
            ...
            //検索語句を渡す
            UserDataBeans udb = (UserDataBeans)hs.getAttribute("search");
